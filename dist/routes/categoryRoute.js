...
router.get("/get_all_category", verifyJWT_1.authenticateToken, categoryController_1.getAllCategories);
router.get("/get_category/:categoryId", verifyJWT_1.authenticateToken, categoryController_1.getCategory);
