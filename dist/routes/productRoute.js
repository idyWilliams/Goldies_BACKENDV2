...
router.get("/get_all_product", verifyJWT_1.authenticateToken, productController_1.getAllProducts);
router.get("/get_product/:productId", verifyJWT_1.authenticateToken, productController_1.getProduct);
